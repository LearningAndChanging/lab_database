...
<body>
<div class="main">
<div class="top_title"><p>Draw IV Curve（如果图片无法正常刷新，请单击图片进行刷新）</p></div>
<div class="container">
<div class="left">
<div class="loadfile">
<?php
...
<div class="right">
IVCurve:
<img src="pythonscript/png/IVCurve.png?nocache="+Math.random() style='width:600px;height:450px; -0px 30px;cursor:pointer;' id='img1' onClick="this.src='pythonscript/png/IVCurve.png?nocache='+Math.random()" />
<div class="drawarea">
<div class="drawarea2 parameter_change">
</div>
<div class="drawarea2 parameter_change">
参数设置：
<p>电池面积 = <span contenteditable="true" id=areanow>请输入电池面积</span> cm2</p>
<button id="parameter">参数更改</button>
<button id="initial_parameter">原始参数</button>
<button id="draw_IV">绘制cv曲线</button>
<p>
<a href="./upload/all/汇总.xls?nocache="+Math.random() class="a_demo_one">
IV汇总数据下载
</a>
</p>
</div>
