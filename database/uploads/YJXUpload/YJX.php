...
<body>
<div class="main">
<div class="top_title"><p>Draw OrganicPaste Rheo Curve（如果图片无法正常刷新，请单击图片进行刷新）</p></div>
<div class="container">
<div class="left">
<div class="loadfile">
<?php
...
<button id="draw_IV">绘制流变曲线</button>
<p>
<a href="./upload/all/流变汇总.xls?nocache="+Math.random() class="a_demo_one">
流变汇总数据下载
</a>
</p>
</div>
